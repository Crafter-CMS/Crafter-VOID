...
export const serverPunishmentService = () => {
  const service = new PunishmentService();

  return {
    searchPunishments: service.searchPunishments.bind(service),
    getPunishments: service.getPunishments.bind(service),
    getPunishmentsByType: service.getPunishmentsByType.bind(service),
    getActivePunishments: service.getActivePunishments.bind(service),
    searchPlayerPunishments: service.searchPlayerPunishments.bind(service),
  };
};
